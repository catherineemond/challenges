...
function findAllLocationsVisited() {
  ...
  while (frontier.length > 0) {
    ...
    if (stepsToPosition[current] == maxSteps) continue;
  ...
  return Object.keys(stepsToPosition).length;
}

console.log(findAllLocationsVisited()); // 141
